...
function SubmitButton({ isSubmitting }: { isSubmitting: boolean }) {
  return (
    <Button type="submit" className="w-full" disabled={isSubmitting}>
      {isSubmitting ? <> <Settings className="mr-2 h-4 w-4 animate-spin" />Đang gửi...</> : <><Send className="mr-2 h-4 w-4" />Gửi phản hồi</>}
    </Button>
  );
}
...
const FeedbackForm = ({ eventId }: { eventId: string }) => {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    try {
      const result = await submitFeedback(initialState, formData);
  ...
  return (
    <section id="feedback-section" className="bg-muted/40">
              ...
              <form ref={formRef} onSubmit={async (e) => {
                ...
                {!isDetailed ? (
                  ...
                  <div className="space-y-6">
                    <StarRatingInput name="rating" label="Bạn đánh giá chung về sự kiện này như thế nào?" required />
                    <div className="space-y-2">
                    ...
                    <Accordion type="single" collapsible defaultValue="item-1" className="w-full">
                      <AccordionItem value="item-1">
                        ...
                        <AccordionContent className="pt-4 pl-2 space-y-4">
                          <StarRatingInput name="rating" label="Mức độ hài lòng tổng thể của bạn" required />
                          <div className="space-y-2">
                      ...
                      <AccordionItem value="item-2">
                        ...
                        <AccordionContent className="pt-4 pl-2 space-y-4">
                          <StarRatingInput name="rating_organization" label="Chất lượng công tác tổ chức (địa điểm, thời gian, hỗ trợ...)" required />
                          <div className="space-y-2">
                      ...
                      <AccordionItem value="item-3">
                        ...
                        <AccordionContent className="pt-4 pl-2 space-y-4">
                          <StarRatingInput name="rating_content" label="Chất lượng nội dung được chia sẻ" required />
                          <div className="space-y-2">
                      ...
                      <AccordionItem value="item-4">
                        ...
                        <AccordionContent className="pt-4 pl-2 space-y-4">
                          <StarRatingInput name="rating_speaker" label="Chất lượng của diễn giả" required />
                          <div className="space-y-2">
